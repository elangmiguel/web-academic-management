...
public abstract class CrudDAO<Entity extends BaseModel, RequestDTO, ResponseDTO, PatchDTO> {
    ...
    /**
     * Obtiene el mapper responsable de convertir entre Entity y los DTOs correspondientes.
     *
     ...
     *
     * @return Cadena con columnas y placeholders separados por coma, sin incluir WHERE.
     */
    protected abstract String updateSetSql();

    /**
     * Establece los parámetros de un PreparedStatement para una actualización completa.
     *
