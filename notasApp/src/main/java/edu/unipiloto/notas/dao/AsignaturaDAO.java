 ...
 * 
 * <p>
 * Esta clase extiende {@link CrudDAO} y proporciona las implementaciones concretas
 * de mapeo, columnas SQL y construcción de sentencias para la tabla "asignatura".
 * Permite operaciones CRUD completas, así como actualizaciones parciales (PATCH),
 ...
 *   <li>Columnas SELECT: {@code id, docente_id, nombre, intensidad_horaria, created_at, updated_at}</li>
 *   <li>Columnas INSERT: {@code docente_id, nombre, intensidad_horaria}</li>
 *   <li>Columnas UPDATE: {@code docente_id = ?, nombre = ?, intensidad_horaria = ?}</li>
 * </ul>
 * </p>
 * 
 * <p>
 * Utiliza {@link MapperFactory#asignatura()} para obtener un {@link AsignaturaMapper}
...
public class AsignaturaDAO extends CrudDAO<
     ...
     *
     * @return Instancia de {@link AsignaturaMapper} implementando {@link BaseMapper}
     */
    @Override
    ...
    /**
     * Establece los parámetros de un PreparedStatement para la actualización completa.
     *
    ...
    /**
     * Construye dinámicamente la sentencia SQL y lista de parámetros para un PATCH parcial.
     *
     * @param sql Acumulador de la sentencia SQL (SET parcial)
     * @param params Lista de parámetros correspondientes a las columnas a actualizar
     * @param patch DTO {@link AsignaturaPatch} con los campos parcialmente modificados
     */
    @Override
